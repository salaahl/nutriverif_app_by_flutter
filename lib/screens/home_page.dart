        ...
        child: ListView(
          ...
          children: [
            ...
            TweenAnimationBuilder<double>(
              tween: Tween(begin: _animatedList[0] ? 1.0 : 0.0, end: 1.0),
            ...
            TweenAnimationBuilder<double>(
              tween: Tween(begin: _animatedList[1] ? 1.0 : 0.0, end: 1.0),
              duration: const Duration(milliseconds: 800),
              builder: (context, value, child) {
                return Opacity(
                  opacity: value,
              ...
              onEnd: () => setState(() => _animatedList[1] = true),
              child: Column(
                children: [
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
            ...
            const SizedBox(height: 80),
            TweenAnimationBuilder<double>(
              tween: Tween(begin: _animatedList[2] ? 1.0 : 0.0, end: 1.0),
              duration: const Duration(milliseconds: 800),
              builder: (context, value, child) {
                return Opacity(
                  opacity: value,
              ...
              onEnd: () => setState(() => _animatedList[2] = true),
              child: Column(
                children: [
                  Row(
                    children: [
            ...
            const SizedBox(height: 80),
            VisibilityDetector(
              key: const Key('visible-detector'),
              onVisibilityChanged: (info) {
                if (info.visibleFraction == 1.0 && !_animatedList[3]) {
                  setState(() {
                    _animatedList[3] = true;
                  });
                }
              },
              child: TweenAnimationBuilder<double>(
                tween: Tween(begin: _animatedList[3] ? 1.0 : 0.0, end: 1.0),
                duration: const Duration(milliseconds: 800),
                builder: (context, value, child) {
                  return Opacity(
                    opacity: value,
            ...
            VisibilityDetector(
              key: const Key('visible-detector'),
              onVisibilityChanged: (info) {
                if (info.visibleFraction == 1.0 && !_animatedList[4]) {
                  setState(() {
                    _animatedList[4] = true;
                  });
                }
              },
              child: TweenAnimationBuilder<double>(
                tween: Tween(begin: _animatedList[4] ? 1.0 : 0.0, end: 1.0),
                duration: const Duration(milliseconds: 800),
                builder: (context, value, child) {
                  return Opacity(
                    opacity: value,
            ...
            VisibilityDetector(
              key: const Key('visible-detector'),
              onVisibilityChanged: (info) {
                if (info.visibleFraction == 1.0 && !_animatedList[5]) {
                  setState(() {
                    _animatedList[5] = true;
                  });
                }
              },
              child: TweenAnimationBuilder<double>(
                tween: Tween(begin: _animatedList[5] ? 1.0 : 0.0, end: 1.0),
                duration: const Duration(milliseconds: 800),
                builder: (context, value, child) {
                  return Opacity(
                    opacity: value,
            ...
            VisibilityDetector(
              key: const Key('visible-detector'),
              onVisibilityChanged: (info) {
                if (info.visibleFraction == 1.0 && !_animatedList[6]) {
                  setState(() {
                    _animatedList[6] = true;
                  });
                }
              },
              child: TweenAnimationBuilder<double>(
                tween: Tween(begin: _animatedList[6] ? 1.0 : 0.0, end: 1.0),
                duration: const Duration(milliseconds: 800),
                builder: (context, value, child) {
                  return Opacity(
                    opacity: value,
